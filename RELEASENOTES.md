...
Be sure the bin path of gradle has been set in you Envrionment Variables
## INSTALLATION
...
1. [Copy the source code to Working dir]Copy the source code folder(./src/gradle) to <tomcat_dir>/webapps/RDKServer/workingDirectory/ActionPacks
